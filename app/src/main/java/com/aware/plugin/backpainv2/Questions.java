...
public class Questions {
    ...
    private static String[] questions = new String[12];

    private Questions() {

        questions[0] = "{'esm':{" +
                "'esm_type':" + ESM.TYPE_ESM_TEXT + "," +
                "'esm_title': 'Registration'," +
                "'esm_instructions': 'Please enter your Registration Code below'," +
                "'esm_submit': 'Submit'," +
        ...
        questions[2] = "{'esm':{" +
                ...
                "'esm_expiration_threashold': 60," + //the user has 60 seconds to respond. Set to 0 to disable
                "'esm_trigger': ''" +
                "}}";
        questions[3] = "{'esm':{" +
                "'esm_type':" + ESM.TYPE_ESM_RADIO + "," +
